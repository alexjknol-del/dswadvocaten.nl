...
ARTICLES = [
 {'slug': 'testament-en-levenstestament', 'titel': 'Wat is het verschil tussen een testament en een levenstestament?', 'cat': 'Erfrecht', 'datum': '2026-09-18', 'datum_nl': '18 september 2026', 'leestijd': 4, 'excerpt': 'Een testament regelt wat er na overlijden gebeurt, een levenstestament wat er tijdens het leven moet gebeuren als iemand zelf niet meer kan beslissen.', 'body': [('p', 'Een testament en een levenstestament klinken als documenten met ongeveer dezelfde functie. Toch regelen ze twee verschillende situaties. Het belangrijkste verschil zit in het moment waarop ze van betekenis zijn. Een testament gaat over wat er na uw overlijden gebeurt. Een levenstestament legt juist vast wat er tijdens uw leven moet gebeuren als u zelf tijdelijk of blijvend niet meer in staat bent om bepaalde zaken te regelen.'), ('plink', 'Bij <a href="https://huiskesnotariaat.nl/" target="_blank" rel="noopener">Huiskes Notaris</a> kunt u terecht voor advies over beide documenten. Maar wanneer heeft u welk document nodig en waarom kan het verstandig zijn om uw wensen vooraf vast te leggen?'), ('h2', 'Wat regelt u met een testament?'), ('p', 'Een testament bepaalt wat er met uw nalatenschap gebeurt na uw overlijden. Zonder testament bepaalt de wet wie uw erfgenamen zijn en hoe uw nalatenschap wordt verdeeld. Met een testament kunt u hiervan afwijken en specifieke wensen vastleggen.'), ('p', 'U kunt bijvoorbeeld bepalen wie uw erfgenamen zijn, bepaalde bezittingen aan iemand nalaten of een executeur aanwijzen. Ook kunt u vastleggen wie voor uw kinderen zorgt wanneer u en de andere ouder komen te overlijden.'), ('p', 'Een testament heeft dus betrekking op de periode na uw overlijden. Zolang u leeft, geeft het document een ander geen bevoegdheid om namens u financiële of persoonlijke zaken te regelen.'), ('h2', 'Waarvoor dient een levenstestament?'), ('p', 'Een levenstestament werkt juist tijdens uw leven. Het kan van belang zijn wanneer u door ziekte, een ongeval of een andere situatie niet meer zelf beslissingen kunt nemen of uw administratie kunt regelen.'), ('p', 'In een levenstestament kunt u iemand aanwijzen die namens u bepaalde zaken mag regelen. Denk aan financiële zaken, het beheren van uw woning of het onderhouden van contacten met instanties. U kunt daarnaast persoonlijke en medische wensen opnemen.'), ('p', 'Het uitgangspunt is dat u zelf bepaalt wie u vertrouwt en welke bevoegdheden die persoon krijgt. Huiskes Notaris kan uitleggen welke keuzes u daarbij kunt maken en hoe deze juridisch worden vastgelegd.'), ('h2', 'Waarom zijn beide documenten verschillend?'), ('p', 'Het verschil wordt vooral duidelijk wanneer u naar het moment van uitvoering kijkt. Een testament treedt in werking na overlijden, terwijl een levenstestament bedoeld is voor situaties waarin u nog leeft maar niet meer zelfstandig kunt handelen.'), ('p', 'De documenten vullen elkaar daarom aan. Met een testament legt u vast wat er met uw nalatenschap moet gebeuren. Met een levenstestament bepaalt u wie tijdens uw leven namens u mag handelen wanneer u dat zelf niet meer kunt.'), ('h2', 'Wanneer is het verstandig om uw wensen vast te leggen?'), ('p', 'Veel mensen denken pas aan een testament of levenstestament wanneer er een directe aanleiding is. Toch kunnen grote veranderingen in uw persoonlijke of financiële situatie een goed moment zijn om uw wensen opnieuw te bekijken. Denk aan een huwelijk, samenwonen, de geboorte van een kind, een scheiding of de aankoop van een woning.'), ('p', 'Ook bestaande documenten kunnen na verloop van tijd niet meer aansluiten bij uw huidige situatie. Huiskes Notaris kan samen met u bekijken welke afspraken relevant zijn en welke documenten daarbij passen.'), ('plink', 'Een testament en een levenstestament hebben dus ieder een eigen doel. Door vooraf na te denken over wat u wilt regelen, houdt u zelf de regie over belangrijke juridische en persoonlijke zaken. <a href="https://huiskesnotariaat.nl/" target="_blank" rel="noopener">Huiskes Notaris</a> kan u informeren over de mogelijkheden en helpen om uw wensen zorgvuldig vast te leggen.'), ('p', DISCLAIMER)]},
...
<div class="card"><h3>Lindenhaeghe</h3><p>Lindenhaeghe verzorgt opleidingen in de financiele sector, waaronder een opleiding tot schuldhulpverlener.</p><p style="margin-top:10px"><a href="https://lindenhaeghe.nl/schuldhulpverlening" target="_blank" rel="noopener">opleiding schuldhulpverlener</a></p></div>
<div class="card"><h3>CS Opleidingen</h3><p>CS Opleidingen biedt een basisopleiding tot casemanager aan voor professionals in verzuim- en re-integratiebegeleiding.</p><p style="margin-top:10px"><a href="https://cs-opleidingen.nl/opleidingen/basis-opleiding-casemanager" target="_blank" rel="noopener">opleiding tot casemanager</a></p></div>
<div class="card"><h3>FOI</h3><p>FOI biedt vastgoedopleidingen aan, waaronder een opleiding huurrecht woonruimte.</p><p style="margin-top:10px"><a href="https://foi.nl/vastgoed/opleiding-huurrecht-woonruimte" target="_blank" rel="noopener">Opleiding Huurrecht</a></p></div>
<div class="card"><h3>Elan Notarissen</h3><p>Elan Notarissen heeft meerdere vestigingen in Nederland, waaronder een notaris in IJmuiden.</p><p style="margin-top:10px"><a href="https://elannotarissen.nl/vestigingen/eric-ros-ijmuiden/" target="_blank" rel="noopener">Notaris IJmuiden</a></p></div>
<div class="card"><h3>Ondernemersklankbord</h3><p>Ondernemersklankbord begeleidt ondernemers met advies van ervaren vakgenoten, onder meer bij het kopen van een bedrijf.</p><p style="margin-top:10px"><a href="https://ondernemersklankbord.nl/bedrijf-kopen/" target="_blank" rel="noopener">bedrijf kopen</a></p></div>
<div class="card"><h3>Eerste Hulp bij Onrecht</h3><p>Eerste Hulp bij Onrecht informeert mensen die te maken hebben met een geweigerde VOG over hun rechten en mogelijkheden.</p><p style="margin-top:10px"><a href="https://www.eerstehulpbij-onrecht.nl/vog-afgewezen-wat-nu/" target="_blank" rel="noopener">VOG geweigerd, wat nu</a></p></div>
<div class="card"><h3>Claimly</h3><p>Claimly helpt consumenten bij het indienen van claims, waaronder een energieclaim.</p><p style="margin-top:10px"><a href="https://www.claimly.nl/energieclaim" target="_blank" rel="noopener">energieclaim indienen bij Claimly</a></p></div>
<div class="card"><h3>LearnCare</h3><p>LearnCare verzorgt de opleiding tot bewindvoerder.</p><p style="margin-top:10px"><a href="https://learncare.nl/opleidingen/bewindvoerder" target="_blank" rel="noopener">opleiding bewindvoerder</a></p></div>
<div class="card"><h3>Nederlands Compliance Instituut</h3><p>Het Nederlands Compliance Instituut verzorgt de leergang compliance professional.</p><p style="margin-top:10px"><a href="https://compliance-instituut.nl/opleidingen/leergang-compliance-professional" target="_blank" rel="noopener">compliance officer opleiding</a></p></div>
<div class="card"><h3>WWZ Academie</h3><p>De WWZ Academie verzorgt opleidingen voor professionals in het sociaal domein.</p><p style="margin-top:10px"><a href="https://wwz-academie.nl/" target="_blank" rel="noopener">wmo opleiding</a></p></div>
<div class="card"><h3>Ik ben Frits</h3><p>Ik ben Frits behandelt het oversluiten van een hypotheek en de afwegingen daarbij.</p><p style="margin-top:10px"><a href="https://www.ikbenfrits.nl/hypotheek-oversluiten/" target="_blank" rel="noopener">Hypotheek oversluiten</a></p></div>
<div class="card"><h3>King nascholing</h3><p>King nascholing verzorgt de opleiding cognitieve gedragstherapie.</p><p style="margin-top:10px"><a href="https://www.kingnascholing.nl/opleidingen/cognitieve-gedragstherapie" target="_blank" rel="noopener">CGT opleiding</a></p></div>
<div class="card"><h3>Axento</h3><p>Axento verzorgt vermogensbeheer voor particulieren en bedrijven.</p><p style="margin-top:10px"><a href="https://axento.nl/vermogensbeheer" target="_blank" rel="noopener">vermogensbeheer</a></p></div>
<div class="card"><h3>Care IS</h3><p>Care IS verzorgt vermogensbeheer voor particulieren.</p><p style="margin-top:10px"><a href="https://care-is.nl/vermogensbeheer/particulier/" target="_blank" rel="noopener">Vermogensbeheer voor de particulier</a></p></div>
</div>
  </div>
</section>"""
    h+=footer(); write(path,h)
